...
mngr.emp_id , mngr.emp_name from employee as emp join
employee as mngr where emp.manager_id = mngr.emp_id ;

select emp.emp_id , emp.emp_name , emp.manager_id , 
mngr.emp_id , mngr.emp_name from employee as emp join
employee as mngr where emp.manager_id = mngr.emp_id group by mngr.emp_name ;

select mngr.emp_name , count(emp.emp_id)from employee as emp join
employee as mngr where emp.manager_id = mngr.emp_id group by mngr.emp_name ;
