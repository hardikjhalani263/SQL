...
select * from product ;
select p.pid , p.price , o.productid , o.city  from product as p join orders as o where  p.pid=o.productid ;

select p.pid , p.price , o.productid , o.city  from product as p cross join orders as o ;

select p.pid , p.price , o.productid , o.city  from product as p natural join orders as o ;

use sakila;
select * from actor;
select * from film_actor;

select a.actor_id , a.last_name, a.first_name , f.film_id from actor as a join film_actor as f where a.actor_id=f.actor_id;

select * from film;

select a.actor_id , a.first_name , fa.actor_id , fa.film_id , flm.film_id as film , flm.title
      from actor a join film_actor as fa  join film as flm 
